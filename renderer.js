...
const TRANSLATIONS = {
  en: {
    ...
    SETTING_GOLD_OVERLAY_TITLE: "Gold Overlay",
    SETTING_GOLD_OVERLAY_DESC: "Shows total spent gold difference overlay when you press the TAB key in-game.",
    ...
    SETTING_DISCORD_RPC_DESC: "Show your active game status and champion in your Discord profile.",
    BTN_BROWSE: "Browse",
    BTN_SAVE: "Save",
    ...
    LOL_ENABLED_SCANNING: "SEARCHING LOL...",
  ...
  es: {
    ...
    SETTING_GOLD_OVERLAY_TITLE: "Superposición de Oro",
    SETTING_GOLD_OVERLAY_DESC: "Muestra la diferencia de oro total y por rol al mantener pulsado el TABULADOR en partida.",
    ...
    SETTING_DISCORD_RPC_DESC: "Muestra el estado de tu partida y tu campeón en tu perfil de Discord.",
    BTN_BROWSE: "Examinar",
    BTN_SAVE: "Guardar",
    ...
    LOL_ENABLED_SCANNING: "BUSCANDO LOL...",
